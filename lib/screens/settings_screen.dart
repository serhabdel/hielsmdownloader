          ...
          return ListView(
            ...
            children: [
              ...
              _SettingsCard(
                ...
                title: 'Version',
                subtitle: '1.0.0 — Built for personal use, no ads, no BS.',
              ),
              const SizedBox(height: 10),
              ...
              _SettingsCard(
                ...
                title: 'Powered by',
                subtitle:
                    'youtube_explode_dart (YouTube) · cobalt.tools API (social media)',
              ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _platformRow(
                      ...
                      'Instagram',
                      'Reels, posts — via cobalt.tools',
                    ),
                    _platformRow(
                      Icons.music_note,
                      const Color(0xFF69C9D0),
                      'TikTok',
                      'Videos — via cobalt.tools',
                    ),
                    _platformRow(
                      Icons.flutter_dash,
                      const Color(0xFF1DA1F2),
                      'Twitter/X',
                      'Video tweets — via cobalt.tools',
                    ),
                    _platformRow(
                      Icons.facebook,
